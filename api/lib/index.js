...
var swaggerDocument = _interopRequireWildcard(require("../swagger.json"));
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                app.use('/swagger', _swaggerUiExpress["default"].serve, _swaggerUiExpress["default"].setup(swaggerDocument));
